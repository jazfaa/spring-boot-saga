...
import com.saga.inventory.kafka.source.ItemFetchedEventSource;
import com.saga.inventory.kafka.source.ItemOutOfStockEventSource;
...
public class InventoryService {
	...
	public void fetchItem(Long orderId) {
		...
		Boolean isInStock = isItemExistsInItemDatabase(orderId);
